...
<html>
	...
	<body>
		<div>
			<html:link action="toAddUser.do?method=toAddUser" title="添加用户">添加用户</html:link>
			<display:table name="userList" class="simple" id="user" pagesize="20"
				defaultsort="1" defaultorder="descending"
				requestURI="listUser.do?method=listUser">
				<display:column property="userId" title="用户ID" sortable="true"
					headerClass="sortable" />
				<display:column property="userName" title="用户名" sortable="true"
					headerClass="sortable" />
				<display:column property="userPwd" title="用户密码" style=""
					maxLength="5" sortable="true" headerClass="sortable" />
				<display:column property="userSex" title="用户性别" sortable="true"
					headerClass="sortable" decorator="org.peigen.ssh.commons.displayColumnDecorator" />
